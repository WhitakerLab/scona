...
class FixturesTest(unittest.TestCase):
    ...
    def test_corrmat_matches_fixture(self):
        ...
        self.assertTrue(filecmp.cmp(os.getcwd()+'/tmp'+self.corrmat, os.getcwd()+'/test_fixtures'+self.corrmat))

    def test_global_measures_against_fixture(self):
        print('\ntesting that global_measures matches fixture')
        self.assertTrue(filecmp.cmp(os.getcwd()+'/tmp'+self.global_measures,os.getcwd()+'/test_fixtures'+self.global_measures))
    
    def test_local_measures_against_fixture(self):
        print('\ntesting that local_measures matches fixture')
        self.assertTrue(filecmp.cmp(os.getcwd()+'/tmp'+self.local_measures,os.getcwd()+'/test_fixtures'+self.local_measures))
    
    def test_rich_club_against_fixture(self):
        print('\ntesting that rich_club matches fixture')
        self.assertTrue(filecmp.cmp(os.getcwd()+'/tmp'+self.rich_club,os.getcwd()+'/test_fixtures'+self.rich_club))  
