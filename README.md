...
The Brain Networks in Python code was implemented in the Neuroscience in Psychiatry Network publication "Adolescence is associated with genomically patterned consolidation of the hubs of the human brain connectome" published in PNAS in 2016 (Whitaker*, Vertes* et al, 2016). That code is still available at https://github.com/KirstieJane/NSPN_WhitakerVertes_PNAS2016. We are now taking that code refactoring it, introducing testing, and providing documentation and tutorials, in order that it is available for everyone to use.
...
If you have questions or want to get in touch you can join our [gitter lobby](https://gitter.im/WhitakerLab/BrainNetworksInPython?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge), tweet @Whitaker_Lab or email Isla at islastaden __*at*__ gmail __*dot*__ com.
